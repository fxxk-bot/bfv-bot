...
| 自动宵禁       | ✅             |
| 自定义命令名称    | ✅             |
| 服内喊话       | 迁移到此项目 [战地5公告机](https://github.com/fxxk-bot/bfv-notice-bot) |
...
> 基于战地5哔哔姬, 需要先登录好账号, 输入/all 切换频道, 然后机器人定时发送消息给小电视. 需要保持游戏内在线. 局内或观战都行
>
> 开始喊话: `op=start-broadcast`
>
> 停止喊话: `op=stop-broadcast`

即将迁移到此项目 [战地5公告机](https://github.com/fxxk-bot/bfv-notice-bot)
